...
### 1.4 Реализация скидок на фронтенде и бэкенде

Сейчас ml модель использует информацию о скидках из таблицы для построения рекомендаций, но в самом приложении скидки не реализованы.

**Решение:**
- Реализовать компоненты скидок на фронтенде.
- Реализовать поддержку изменения цены в зависимости от скидки на бэкенде
