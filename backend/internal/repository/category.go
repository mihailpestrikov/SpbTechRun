...
func (r *CategoryRepository) GetChildren(ctx context.Context, parentID int) ([]model.Category, error) {
	query, args, err := r.sq.
		Select("id", "parent_id", "name").
		From("categories").
...
func (r *CategoryRepository) GetRoots(ctx context.Context) ([]model.Category, error) {
	query, args, err := r.sq.
		Select("id", "parent_id", "name").
		From("categories").
